...
now download this firmware https://androidfilehost.com/?fid=6006931924117929427
...
if instead you see "fail" dont panic, its really easy to fix, follow these steps.
download twrp from the release or download it from this link:https://eu.dl.twrp.me/klte/twrp-3.7.0_9-0-klte.img.tar
if you are still in download mode, hold volume down+power than when your phone goes dark hold volume down plus home now.
press volume up
than select ap, select the twrp file you downloaded, go to options uncheck auto reboot and start flash
when the flash is done, hold volume down+power than home+volume up,when in twrp swipe for modifications,go to wipe, format data, then type yes
click "reboot system" and enjoy!
thats it
